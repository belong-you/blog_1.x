		...
		<div class="wrapper-right fr">
			...
			<div class="about border">
				...
				<div class="content">
					...
					<p>Gmail：<a href="mailto:1781926993@qq.com">bozai.ojbk@gmail.com</a></p>
...
export default {
	...
	async created () {
		const data = await axios.getArticleList();
		this.dynamic = data;

		// 推荐列表
		const obj = Object.entries(data);  // 对象转数组
		const arr = [];
		[...obj].forEach((val, i) => {
			arr.push(val);
		})
	...
	methods: {
		...
		async getFriendLink () {
			await axios.getFriendLink().then(res => {
				this.friendLink = res;
			})
		}
	},
