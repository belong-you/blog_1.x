...
export default {
	data () {
		...
		abouts: [
			...
			{ name: 'Gmail', content: 'bozai.ojbk@gmail.com', link: 'mailto:bozai.ojbk@gmail.com', },
		...
		blog: [
			...
			{ name: '运用技术', content: '利用 Vue2、 Element-UI 框架搭建页面，后端接口由 Node.js 搭建，数据库采用 Mysql，后台管理系统用 vite + React + TypeScript + antd 搭建' },
		],
		journal: [
